  ...
  return (
    ...
    >
      <div className="flex flex-col h-full min-h-0 relative z-10">
        <div className="absolute inset-x-0 top-0 h-[150px] -z-10 overflow-hidden rounded-t-3xl group-data-[variant=floating]:rounded-t-lg">
          <img
            src={sidebarBgLogo}
            alt=""
            aria-hidden="true"
      ...
      <div
        className={`fixed inset-0 z-[60] bg-black/10 dark:bg-white/10 backdrop-blur-[1px] transition-all duration-200 ${actionOpen ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"}`}
