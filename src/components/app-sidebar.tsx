...
export function AppSidebar({ 
  ...
  return (
    ...
    >
      ...
      <div
        className={`fixed inset-0 z-[60] bg-black/70 backdrop-blur-[1px] transition-all duration-200 ${actionOpen ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"}`}
