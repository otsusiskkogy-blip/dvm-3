  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          // For floating variant, keep the sidebar inset from the viewport edges
          variant === "floating"
            ? "fixed top-6 bottom-6 z-50 hidden w-(--sidebar-width) transition-[left,right,width,top,bottom] duration-[250ms] ease-[cubic-bezier(0.4,0,0.6,1)] md:flex"
            : "fixed inset-y-0 z-50 hidden w-(--sidebar-width) transition-[left,right,width] duration-[250ms] ease-[cubic-bezier(0.4,0,0.6,1)] md:flex",
              side === "left"
                ? variant === "floating"
                  ? "left-6 group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1-1.5rem)] group-data-[state=collapsed]:left-[calc(var(--sidebar-width)*-1-1.5rem)]"
                ...
                : variant === "floating"
                ? "right-6 group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1-1.5rem)] group-data-[state=collapsed]:right-[calc(var(--sidebar-width)*-1-1.5rem)]"
